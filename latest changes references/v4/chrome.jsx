  ...
  return (
    <header className="aw-header">
      <div className="aw-header-main">
        ...
        <span className="aw-status-pill" title={"run " + runState + " · " + tokenInfo.tok + " tokens · $" + tokenInfo.cost}>
